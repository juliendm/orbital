...
bounds.parameter.lower = [dv1_min,dv2_min,dv3_min,dv4_min];
bounds.parameter.upper = [dv1_max,dv2_max,dv3_max,dv4_max];
...
bounds.phase(ph).initialstate.lower = [r_0,lon_0,lat_0,v_0,gam_0,al_min,dry_mass_min+auxdata.us_mass+auxdata.fuel_mass,aoa_0,bank_0];  %
bounds.phase(ph).initialstate.upper = [r_0,lon_0,lat_0,v_0,gam_0,al_max,dry_mass_max+auxdata.us_mass+auxdata.fuel_mass,aoa_0,bank_0];  %
...
guess.parameter = [0.0,0.0,0.0,0.0];
...
bounds.eventgroup(7).lower = [ 0.0*d2r,  2150.0, 100000.0];         % gam, speed, altitude
bounds.eventgroup(7).upper = [30.0*d2r, 90000.0, 200000.0];         %
...
elseif restart == 3
    ...
    setup.guess.parameter = [0.5,0.459498,-0.5,-0.2]; % SHOULD PUT THE CONVERGED GUESS HERE
