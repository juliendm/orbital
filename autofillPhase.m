...
function [] = autofillPhase ()
	...
	xxx.initialstate.lower = [r_min,lon_min,lat_min,v_min,gam_min,al_min,m_min,aoa_min,bank_min]; 
	xxx.initialstate.upper = [r_max,lon_max,lat_max,v_max,gam_max,al_max,m_max,aoa_max,bank_max];
	xxx.state.lower =        [r_min,lon_min,lat_min,v_min,gam_min,al_min,m_min,aoa_min,bank_min];
	xxx.state.upper =        [r_max,lon_max,lat_max,v_max,gam_max,al_max,m_max,aoa_max,bank_max];
	xxx.finalstate.lower =   [r_min,lon_min,lat_min,v_min,gam_min,al_min,m_min,aoa_min,bank_min];
	xxx.finalstate.upper =   [r_max,lon_max,lat_max,v_max,gam_max,al_max,m_max,aoa_max,bank_max];

	xxx.control.lower = [daoa_min,dbank_min];
	xxx.control.upper = [daoa_max,dbank_max];
	...
	xxx.control = [[daoa_0;daoa_f],[dbank_0;dbank_f]];
